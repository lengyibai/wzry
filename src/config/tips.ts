...
const tips_tc: Tips<string> = {
  "3vi5": "",
  "9ms5": "",
  "2rb7": "我又回來了！",
  "9f5m": "不要忽略右上角的工具欄哦！",
  "58mz": "底部工具欄可以切換音樂哦！",
  "05su": "點擊英雄關係，可以切換英雄信息哦！",
  //PC端专属
  "0vk2": "鼠標滾輪可滾動到下一頁，也可懸浮右邊中間的索引線，點擊彈出的文字。",
  "9oy5": "按住邊緣頭像，拖動到中心位置並鬆開(點擊頭像也可以)",
  //移动端专属
  "1zs6": "手指需滑動300像素纔會滾動下一頁，也可點擊右邊中間的索引線，彈出的文字滾動。",
  "1w7o": "手指按住邊緣頭像，拖動到中心位置並鬆開(點擊頭像也可以)。",
  "2l5m": "",
};
...
export { tips_zh, tips_tc, tips_en };
