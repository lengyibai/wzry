...
<template>
  <div ref="equipList" class="equip-list">
    <EquipListColumn
      :line-data="synthetic_id[0]"
      :equip-list="equip_list_column[0]"
      :index="0"
    />
    <EquipListColumn
      :line-data="synthetic_id[1]"
      :equip-list="equip_list_column[1]"
      :index="1"
    />
    <EquipListColumn
      :line-data="synthetic_id[2]"
      :equip-list="equip_list_column[2]"
      :index="2"
    />
  </div>
</template>
