<template>
  <div class="EpigraphCategory">
    <img class="cursor-pointer" :style="{ left: currentIndex * 11.11 + '%' }" src="@/assets/img/part/icon/epigraph_active.png" alt="" />
    <div class="title cursor-pointer" :class="{ active: currentIndex === index }" @click="toggle(index, item.title)" v-for="(item, index) in epigraph" :key="index">
