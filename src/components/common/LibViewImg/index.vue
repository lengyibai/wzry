  ...
  <div class="lib-view-img">
    ...
    <div class="tool" ref="tool">
      <div class="clockwise" @click="handleClockwise">
        <svg t="1662135824052" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1399">
          <path
      ...
      <div class="counter" @click="handleCounter">
        <svg t="1662135840330" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1590">
          <path
