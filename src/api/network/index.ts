...
//#####·········配置默认请求··········#####//
//####········GET请求········####//
export function getReq(url: string, params: object) {
  return server({ method: 'GET', url, params });
}

//####········POST请求········####//
export function postReq(url: string, data: object) {
  return server({ method: 'POST', url, data });
}

//####········PUT请求········####//
export function putReq(url: string, data: object) {
  return server({ method: 'PUT', url, data });
}

//####········PATCH请求········####//
export function patchReq(url: string, data: object) {
